...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($pwd == $cpwd)
  {
    $reset_pwd = mysqli_query($connection,"update tbl_student set password='$password' where email='$email'");
    if($reset_pwd>0)
    {
      $msg = 'Your password updated successfully return back to the app to login';
    }
    else
    {
